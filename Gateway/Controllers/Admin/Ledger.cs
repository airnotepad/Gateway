...
namespace Gateway.Controllers
{
    ...
    public partial class AdminController : Controller
    {
        ...
        [HttpPost]
        public JsonResult LedgerTable([FromBody] DTParameters dtParameters, int userid)
        {
            var response = new APIResponse<DTResult<BookkeepingRecord>>();
            ...
            try
            {
                ...
                var result = _context.BookkeepingRecords.AsNoTracking().Where(x => x.User_id == userid).ToList();
                ...
                response.Result = (new DTResult<BookkeepingRecord>
                {
